...
<div class="list-group-sm">
        ...
        <a <?php if(@$_GET['module'] == 'Prodi') { ?> class='list-group-item active' <?php } ?> href="<?php echo site_url('Admin/View_Prodi')?>?module=Prodi" class="list-group-item "><i class="fa fa-file-o tab10" aria-hidden="true"></i> Program Studi</a>
        ...
        <a <?php if(@$_GET['module'] == 'Slider') { ?> class='list-group-item active' <?php } ?> href="<?php echo site_url('Admin/View_Slider')?>?module=Slider" class="list-group-item "><i class="fa fa-file-o tab10" aria-hidden="true"></i> Slider</a>
