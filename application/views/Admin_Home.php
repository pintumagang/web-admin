       ...
       <div class="row">
            ...
            <div class="col-xs-6 col-md-3 productbox">
              <a href="#" class="thumbnail clearfix">
                <img src="http://localhost/Image/admin.png" width="120px" height="80px" class="img-responsive">
            ...
            <div class="col-xs-6 col-md-3 productbox">
              <a href="#" class="thumbnail clearfix">
                <img src="http://localhost/Image/mahasiswa.png" width="120px" height="80px" class="img-responsive">
            ...
            <div class="col-xs-6 col-md-3 productbox">
              <a href="#" class="thumbnail clearfix">
                <img src="http://localhost/Image/company.png" width="120px" height="80px" class="img-responsive">
