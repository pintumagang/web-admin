...
INSERT INTO `kabupaten_kota` (`id_kabkot`, `id_provinsi`, `nama_kabkot`) VALUES
...
CREATE TABLE `perusahaan` (
  ...
  `id_industri` varchar(100) NOT NULL,
  `status` varchar(20) NOT NULL,
  `email` varchar(50) NOT NULL,
  `link_website` varchar(50) NOT NULL,
